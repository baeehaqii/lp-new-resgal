...
export const metadata: Metadata = {
  title: "Sapphire Residence Tegal - Hunian Premium di Tegal",
  description: "Temukan properti impian Anda di Sapphire Residence Tegal III & IV, hunian premium dengan 800+ unit, lokasi strategis di Jl. Siklepuh Raya, Mejasem, Pacul, Kec. Talang, Kota Tegal dengan fasilitas lengkap dan Smart Door Lock",
  icons: {
  ...
  keywords: [
    "Sapphire Residence Tegal III & IV",
    "Sapphire Griya",
    "Perumahan Tegal",
    "Rumah Tegal",
    "Hunian Premium Tegal",
    "Properti Tegal",
    "800+ Unit Tegal",
    "Smart Door Lock Tegal",
  ],
}
...
'https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);
})(window,document,'script','dataLayer','GTM-TG3MZ6H7');`
        }} />
      ...
      <body style={{ fontFamily: '-apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, sans-serif' }}>
        ...
        <noscript>
          <iframe
            src="https://www.googletagmanager.com/ns.html?id=GTM-TG3MZ6H7"
            height="0"
            width="0"
